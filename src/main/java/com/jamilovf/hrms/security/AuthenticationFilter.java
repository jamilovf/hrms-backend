...
import com.jamilovf.hrms.core.model.request.PersonLoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        String token = Jwts.builder()
                ...
                .compact();
        AuthService authService = (AuthService) SpringApplicationContext.getBean("authManager");
        Person person = authService.getPerson(userName);

        res.addHeader(SecurityConstants.HEADER_STRING, SecurityConstants.TOKEN_PREFIX + token);
        res.addHeader("UserID", person.getId().toString());
